...
struct simple_interface_test
{
    void start(std::string connection_str)
    {
        ...
        throw_if_false(*large_varchar_column == "this is a much larger vchar, SPACE SPACE SPACE SPACE SPACE SPACE SPACE SPACE SPACE SPACE SPACE SPACE SPACE SPACE SPACE ");
